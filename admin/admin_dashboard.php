            ...
            <main class="flex-1 p-4 md:px-8 md:py-4 lg:px-12">
                ...
                <div class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    <div class="flex justify-center items-center mb-4">
                        <h2 class="text-2xl font-semibold text-black dark:text-black">Admin Dashboard - Data Koran</h2>
                    </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div>
                                <label for="filter_day"
                                    class="block text-sm font-medium text-gray-700 mb-1">Hari:</label>
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th class="py-2 px-4">
                                        <span class="text-sm font-medium text-gray-700">Judul Koran</span>
                                    </th>
                                    <th class="py-2 px-4">
                                        <span class="text-sm font-medium text-gray-700">Tanggal Terbit
