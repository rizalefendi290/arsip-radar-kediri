...
<body class="bg-gray-100 py-10">
            ...
            <div class="p-4 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
                <div class="container bg-white shadow-lg rounded-lg px-4 py-6">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        ...
                        <div class="mt-4">
                            <button type="submit"
                                class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded focus:outline-none focus:ring-2 focus:ring-blue-300">Tambah</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <?php if ($_SERVER["REQUEST_METHOD"] == "POST" && empty($name_err)): ?>
    Swal.fire({
        icon: 'success',
        title: 'Category Created',
