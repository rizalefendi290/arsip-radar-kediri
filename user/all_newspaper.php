    ...
    <header class="shadow">
        <div class="container mx-auto py-4 px-4">
            <nav class="flex flex-col items-center md:flex-row md:justify-between" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="ms-1 text-sm font-medium text-black hover:text-blue-600 dark:hover:text-gray-600">Semua Koran</span>
                        </div>
                    </li>
                </ol>
                ...
                <a href="../index.php" class="flex bg-gray-900 hover:bg-gray-800 text-white font-bold py-2 px-4 rounded inline-block mt-4 md:mt-0">
                    ...
                    <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                        ...
                        <div class="px-4 py-4 sm:px-6">
                            <div class="flex justify-center">
                                <a href="view_newspaper.php?id=<?php echo $newspaper['id']; ?>" class="text-green-600 hover:text-green-900 mr-2">Lihat</a>
                                <?php if (isset($role) && $role === 'admin') : ?>
                                    <a href="../admin/edit_newspaper.php?id=<?php echo $newspaper['id']; ?>" class="text-blue-600 hover:text-blue-900 mr-2">Edit</a>
                                    <a href="../admin/delete_newspaper.php?id=<?php echo $newspaper['id']; ?>" class="text-red-600 hover:text-red-900" onclick="return confirm('Are you sure you want to delete this newspaper?')">Delete</a>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
            ...
            <div class="mt-4">
                <nav class="flex justify-center">
                    <ul class="pagination flex items-center space-x-2">
                        <?php if ($page > 1) : ?>
                            <li>
                                <a href="?page=<?php echo $page - 1; ?>" class="px-3 py-2 bg-gray-300 text-gray-800 rounded">Previous</a>
                            </li>
                        <?php endif; ?>
                        <?php for ($i = 1; $i <= $totalPages; $i++) : ?>
                            <li>
                                <a href="?page=<?php echo $i; ?>" class="px-3 py-2 <?php echo $i === $page ? 'bg-gray-800 text-white' : 'bg-gray-300 text-gray-800'; ?> rounded"><?php echo $i; ?></a>
                            </li>
                        <?php endfor; ?>
                        <?php if ($page < $totalPages) : ?>
                            <li>
                                <a href="?page=<?php echo $page + 1; ?>" class="px-3 py-2 bg-gray-300 text-gray-800 rounded">Next</a>
                            </li>
                        <?php endif; ?>
                    </ul>
                </nav>
