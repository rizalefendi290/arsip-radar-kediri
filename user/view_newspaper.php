        ...
        <div class="max-w-screen-xl mx-auto flex flex-wrap items-center justify-between p-4">
            ...
            <div class="hidden md:flex md:w-auto" id="navbar-default">
                <ul
                    ...
                    <li>
                        <a href="../index.php"
                            class="block py-2 px-3 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-white">Beranda</a>
                    </li>
                    <li>
                        <a href="all_newspaper.php"
                            class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white">Semua
                            Koran</a>
                    </li>
                    <?php if ($role === 'admin'): ?>
                    <li>
                        <a href="../admin/admin_dashboard.php"
                            class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white">Dashboard
                            Admin</a>
                    </li>
                    <?php endif; ?>
                    <li class="relative">
                        ...
                        <div id="userMenuDropdown"
                            ...
                            <a href="../profile.php"
                                class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-200">Profile</a>
                            <a href="../logout.php"
                                class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-200">Logout</a>
                        </div>
                        <script>
                        ...
                        <?php else: ?>
                        <a href="../login.php"
                            class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white">Login</a>
                        <?php endif; ?>
                    </li>
                </ul>
            </div>
            ...
            <nav class="flex flex-col items-center md:flex-row md:justify-between" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    <li class="inline-flex items-center">
                        <a href="../index.php"
                            class="inline-flex items-center text-black hover:text-blue-600 dark:hover:text-gray-600">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="all_newspaper.php"
                                class="text-sm font-medium text-black hover:text-blue-600 dark:hover:text-gray-600">Koran</a>
                        </div>
                    </li>
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span
                                class="text-black hover:text-blue-600 dark:hover:text-gray-600"><?php echo htmlspecialchars($newspaper['title']); ?></span>
                        </div>
                    </li>
                </ol>
            </nav>
